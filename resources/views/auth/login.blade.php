                                    ...
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post" action="{{ route('login') }}">
                                            ...
                                            <div class="form-group">
                                                <input type="text" required="" name="email" placeholder="Tu correo">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-fill-out btn-block hover-up" name="login">Acceder</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
