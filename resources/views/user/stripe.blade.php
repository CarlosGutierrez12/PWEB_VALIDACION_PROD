...
<div class="container">
    <h3 class="text-center m-5">Pagar con tarjeta</h3>
    <div class="row">
                    ...
                    <form 
                        ...
                        <div class='form-row row'>
                            <div class='col-md-12 error form-group hide'>
                                <div class='alert-danger alert'>Por favor corregir e intentar de nuevo</div>
                            </div>
                        </div>
    
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pagar (${{$totalPrice}})</button>
                            </div>
                        </div>
