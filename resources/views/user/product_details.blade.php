                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <div class="product_sort_info font-xs mb-30">
                                            <ul>
                                                <li class="mb-10"><i class="fi-rs-refresh mr-5"></i> Hasta 30 dias para devolver el producto</li>
                                                <li><i class="fi-rs-credit-card mr-5"></i> Pago en efectivo en la entrega disponible</li>
                                            </ul>
                                        </div>
                                                ...
                                                <div class="product-extra-link2">
                                                    @if($product->quantity <1)
                                                        <p style="font-size: 12px;">
                                                            Disponibilidad:<span class="in-stock text-danger ml-5">{{$product->quantity}} Cantidad en inventario</span>
                                                        </p>
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            <li>Disponibilidad:<span class="in-stock text-success ml-5">{{$product->quantity}} Cantidad en inventario</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                                        ...
                                        <div class="tab-pane fade show active" id="Additional-info">
                                            <table class="font-md">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>Memoria RAM de tarjeta grafica</th>
                                                        <td>
                                                            <p>{{$product->graphics_card_memory}}</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th>Generación del procesador</th>
                                                        <td>
                                                            <p>{{$product->processor_generation}} Generacion</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-category mb-30">
                            ...
                            <ul class="categories">
                                ...
                                <li><span style="font-weight:bold">Capacidad SSD: </span>{{$product->ssd_capacity}}</li>
                            </ul>
                        </div>                        
                    </div>
                </div>
