                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="{{route('user.clear_cart')}}" class="text-muted"> <i class="fi-rs-cross-small"></i> Limpiar orden</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="cart-action text-end">
                            ...
                            <a class="btn " href="{{url('/cash-order')}}"><i class="fi-rs-shopping-bag mr-10"></i>Efectivo en entrega</a>
                        </div>
