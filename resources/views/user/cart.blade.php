...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end">
                                            <a href="{{route('user.clear_cart')}}" class="text-muted"> <i class="fi-rs-cross-small"></i> Limpiar carrito</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                        ...
                        <div class="cart-action text-end">
                            <a class="btn " href="{{route('user.shop')}}"><i class="fi-rs-shopping-bag mr-10"></i>Continuar comprando</a>
                            <a href="{{route('user.checkout')}}" class="btn"> <i class="fi-rs-box-alt mr-10"></i> Proceder al pago(${{$totalPrice}})</a>
                        </div>
                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="border p-md-4 p-30 border-radius cart-totals">
                                    ...
                                    <a href="{{route('user.checkout')}}" class="btn"> <i class="fi-rs-box-alt mr-10"></i> Proceder al pago</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function confirmation(ev){
            ...
            swal({
                title: '¿Estas seguro que deseas cancelar este producto?',
