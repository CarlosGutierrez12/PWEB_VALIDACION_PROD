                            ...
                            <div class="col-md-4">
                                <div class="dashboard-menu">
                                    <ul class="nav flex-column" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="address-tab" data-bs-toggle="tab" href="#address" role="tab" aria-controls="address" aria-selected="true"><i class="fi-rs-marker mr-10"></i>Mi direccion</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                        <div class="card">
                                            <div class="card-header">
                                                <h5 class="mb-0">Hola {{$user->name}}! </h5>
                                            </div>
                                            <div class="card-body">
                                                <p>Desde el dashboard de tu cuenta puedes monitorear &amp; ver tus <a href="#">ordenes recientes</a>, manejar tus<a href="#">envios y direcciones</a> y <a href="#">editar tu contraseña y detalles de cuenta.</a></p>
                                            </div>
                                        </div>
                                    </div>
