            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="text-center">
                        <h1>No has hecho ninguna orden</h1>
                    ...
                    <div class="col-12 mb-100">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <div class="divider center_icon mt-10 mb-30"><b>Ordenes activas</b></div>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($order->delivery_status == 'pending')
                                                <a class="btn" href="{{url('/cancel-order',$order->id)}}"><i class="fas fa-trash"></i> Cancelar orden</a>
                                            @elseif($order->delivery_status == 'delivered')
                                                <a class="btn" href="{{url('/order-received',$order->id)}}"> Ya recibi los productos</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <div class="divider center_icon mt-100 mb-30"><b>Ordenes pasadas</b></div>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="product-des product-name px-5">
                                            <i style="color: #3EC70B; font-size: 17px;" class="fas fa-check-circle"></i>
                                            <span class="product-name px-1">Producto recibido</span>
                                        </td>
                                        <td class="text-center" data-title="Stock">
                                            <div class="detail-qty border radius  m-auto">
                                                <span class="qty-val">{{$order->quantity}}</span>
