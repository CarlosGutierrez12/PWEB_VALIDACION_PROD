                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-10 m-auto">
                        <div class="contact-from-area padding-20-row-col wow FadeInUp">
                            <h3 class="mb-10 text-center">Envianos un mensaje</h3>
                            <p class="text-muted mb-30 text-center font-sm">Te responderemos cuanto antes
                            <form class="contact-form-style text-center" id="contact-form" action="#">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="input-style mb-20">
                                            <input name="telephone" placeholder="Tu número" type="tel">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="input-style mb-20">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        ...
                                        <button class="submit submit-auto-width" type="button">Enviar</button>
                                    </div>
                                </div>
                            </form>
