...
<html lang="en">
  <head>
    ...
    <title>Admin | Ver productos</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="{{url('/search-product')}}" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="GET">
              @csrf
              <input type="text" name="search" class="form-control" placeholder="Buscar producto" style="color: #fff">
            </form>
                        ...
                        <tbody>
                          @forelse($products as $product)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url('delete_product',$product->id)}}" style="margin: 5px; font-size: 25px; color:#FF6D60"><i class="mdi mdi-delete-sweep"></i></a>
                                </td>
                                <td>
                                    <a href="{{url('edit_product',$product->id)}}" style="margin: 5px; font-size: 20px;color:#7149C6"><i class="mdi mdi-tooltip-edit"></i></a>
                                </td>
                            </tr>
                            @empty
                            <tr>
