                ...
                <div class="col-12 grid-margin">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-description"> Detalles de computador </p>
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Resolucion de pantalla</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Tasa de refresco</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Generacion de procesador</label>
                                        <div class="col-sm-9">
                            ...
                            <p class="card-description"> Tarjeta grafica </p>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Tipo de tarjeta grafica</label>
                                        <div class="col-sm-9">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Memoria de tarjeta grafica</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Capacidad SSD</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Teclados</label>
                                        <div class="col-sm-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label class="col-sm-3 col-form-label">Discuento</label>
                                        <div class="col-sm-9">
