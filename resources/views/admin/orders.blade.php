          ...
          <div class="content-wrapper">
            ...
            <div class="row ">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                        <h4 class="card-title">Ordenes de usuario</h4>
                            ...
                            <tbody>
                                @foreach ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="{{ url('/update-order/'.$order->user_id.'/'.$order->id.'/processing') }}">En proceso</a>
                                                    <a class="dropdown-item" href="{{ url('/update-order/'.$order->user_id.'/'.$order->id.'/pending') }}">Pendiente</a>
                                                    <a class="dropdown-item" href="{{ url('/update-order/'.$order->user_id.'/'.$order->id.'/packaging') }}">Empacando</a>
                                        ...
                                        <td>
                                            <a href="{{url('print-bill', $order->id)}}" class="btn btn-outline-info">Imprimr factura</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
