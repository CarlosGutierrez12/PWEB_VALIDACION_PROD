...
class HomeController extends Controller
{
    ...
    public function AddToCart(Request $request, $id)
    {
        if(Auth::check()){
            ...
            if($request->quantity > $product->quantity){
                Alert::warning('Error!', 'Cantidad requerida excede la cantidad en stock. Tenemos ' . $product->quantity . ' unidades en stock');
        ...
        if (Auth::check()) {
            ...
            if ($removing_product) {
                ...
                if ($product) {
                    ...
                    return redirect()->route('user.cart')->with('success', 'Producto removido del carrito');
                } else {
    ...
    public function ClearCart()
    {
        if (Auth::check()) {
            ...
            return redirect()->back()->with('success', 'Carrito limpiados');
        } else {
            return redirect('login');
        }
    }
    ...
    public function CashOrder()
    {
        if(Auth::check()){
            ...
            Alert::success('Orden recibida', 'Orden recibida');
    ...
    public function CancelOrder($id)
    {
        if (Auth::check()) {
            ...
            // Delete the order
            $order->delete();
            Alert::success('Orden cancelada', 'Orden cancelada');
            return redirect()->back();
        } else {
            return redirect('login');
        }
    ...
    public function StripePost(Request $request, $totalPrice)
    {
        if(Auth::check()){
            ...
            Stripe\Charge::create([
                ...
                "description" => "Gracias por el pago"
            ]);
            ...
            Session::flash('success', 'Pago exisoto');
            Alert::success('Pago exitoso', 'Orden recibida');
